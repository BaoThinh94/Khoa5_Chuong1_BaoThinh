...
export default function Footer(props) {
    ...
    const {layThongTinHeThongRapReducer} = useSelector(state => state.QuanLyRapReducer);
   
    const arrHeThongRap = _.map(layThongTinHeThongRapReducer,(heThongRap) => _.pick(heThongRap,['maHeThongRap','tenHeThongRap','logo']));
