...
import { capNhatThongTinNguoiDungAction, layDanhSachLoaiNguoiDungAction } from '../../../../redux/action/QuanLyNguoiDungAction';
        ...
        <div className="relative sm:w-96 mx-auto text-center">
            ...
            <div className="mt-4  bg-white shadow-md rounded-lg text-left">
                ...
                <form onSubmit={formik.handleSubmit} className="px-8 py-6 ">
                    ...
                    <input name="taiKhoan" disabled onChange={formik.handleChange} type="text" placeholder="Username" className="border w-full h-5 px-3 py-5 mt-2 hover:outline-none focus:outline-none focus:ring-indigo-500 focus:ring-1 round
